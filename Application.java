...
public class Application {
	public static void main(String[]args) {
		Stack<Character> stack = new Stack<Character>(); //stack is the Stack that will be used to flip the user inputed word.
		...
		char [] array = input.toCharArray(); //char array to break down the user inputed word into its characters
		/*
		 * for loop to push each character in the user inputed word onto the stack
		 */
